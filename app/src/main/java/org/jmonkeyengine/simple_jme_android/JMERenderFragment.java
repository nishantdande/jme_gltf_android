...
/**
 * Created by Nishant Dande on 2/13/2018.
 */
 ...
 * @author iwgeric
 */
public class JMERenderFragment extends Fragment implements
        TouchListener, DialogInterface.OnClickListener, View.OnLayoutChangeListener, SystemListener {
    private static final Logger logger = Logger.getLogger(JMERenderFragment.class.getName());
...
//                builder.setPositiveButton("Kill", com.jme3.app.AndroidHarnessFragment.this);
...
//                            builder.setPositiveButton("Yes", com.jme3.app.AndroidHarnessFragment.this);
//                            builder.setNegativeButton("No", com.jme3.app.AndroidHarnessFragment.this);
